...
function WeatherApi(){
    ...
    return(
      <div className="min-h-screen flex items-center justify-center dark:bg-gray-800 heropattern-topography-gray-600">
      <div className="flex flex-col rounded p-4 w-full max-w-lg ">
           <h1 className="text-3xl text-gray-100 mb-4 rounded-lg font-semibold p-4 dark:bg-gray-700 heropattern-diagonallines-gray-600">Weather APP</h1>
